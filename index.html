...
<head>
    <title>COBOFAR ADMINISTRADOR</title>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <!-- Authentication card start -->
                        ...
                        <form class="md-float-material form-material" action="cookie.php" method="POST">
                            <div class="text-center">
                                <img src="assets/images/farmacias_bolivia1.gif" alt="logo.png" width="280px">
                            </div>
                            <div class="auth-box card">
                                <div class="card-block">
                                    <div class="row m-b-20">
                                        <div class="col-md-12">
                                            <h3 class="text-center">COBOFAR</h3>
                                        </div>
                                    </div>
                                    <div class="form-group form-primary">
                                        <input type="text" name="usuario" class="form-control" required="" autocomplete="off">
                                        <span class="form-bar"></span>
                                        <label class="float-label">Ingrese el usuario</label>
                                    </div>
                                    <div class="form-group form-primary">
                                        <input type="password" name="contrasena" class="form-control" required="" autocomplete="off">
                                        <span class="form-bar"></span>
                                    ...
                                    <div class="row">
                                        <div class="col-md-10">
                                            <p class="text-inverse text-left m-b-0">Copy right 2021.</p>
                                            <p class="text-inverse text-left"><a href="index.html"><b>Farmacias Bolivia</b></a></p>
                                        </div>
                                        <div class="col-md-2">
